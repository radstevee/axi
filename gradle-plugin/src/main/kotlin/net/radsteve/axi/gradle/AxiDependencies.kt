...
import net.radsteve.axi.gradle.AxiDependencies.Coordinates.PAPER_API
import net.radsteve.axi.gradle.AxiDependencies.Coordinates.axi
...
public object AxiDependencies {
  public object Coordinates {
    ...
    public fun axi(module: String): String = "net.radsteve.axi:axi-$module"
  }

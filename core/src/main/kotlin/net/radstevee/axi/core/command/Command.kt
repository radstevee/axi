...
public fun Command(name: String, aliases: Set<String> = setOf(), plugin: AxiPlugin = AxiPluginHolder.plugin(), block: CommandBuilder.() -> Unit): Command = CommandBuilder(name, aliases, plugin).apply(block).build()

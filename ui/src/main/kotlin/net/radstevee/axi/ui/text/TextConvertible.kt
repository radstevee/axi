...
public interface TextConvertible : TextComponent {
    ...
    override fun applyFallbackStyle(vararg style: StyleBuilderApplicable): Component =
        asText().applyFallbackStyle(*style)
    ...
    override fun componentBuilderApply(component: ComponentBuilder<*, *>): Unit =
    ...
    override fun decorations(decorations: MutableSet<TextDecoration>, flag: Boolean): Component =
        asText().decorations(decorations, flag)
    ...
    override fun style(consumer: Consumer<Style.Builder>, strategy: Style.Merge.Strategy): Component =
        asText().style(consumer, strategy)
